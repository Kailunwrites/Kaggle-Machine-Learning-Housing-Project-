...
setwd("~/GitHub/Kaggle-Machine-Learning-Housing-Project-/kailun_cheng/R Markdowns_Modeling")

library(dplyr)

# hp_train <- read.csv('../Data/train.csv')

hp_orig <- read.csv('train_all_original.csv')
hp_feat <- read.csv('train_all_feature.csv')
